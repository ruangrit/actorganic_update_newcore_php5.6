...
if (!class_exists('cmfcClassesCore'))
	trigger_error('cmfcCalendarV1:calendarV1 needs cmfcClassesCore packages/cmf/classesCore.class.inc.php',E_USER_ERROR);

class cmfcCalendarV1 extends cmfcClassesCore{
	var $_name;
	var $_language;
	var $_timeZoneName;
	var $_timeZoneInfo;
	...
	function factory($options) {
		...
		if ($options['name']=='thai') {
			require_once(dirname(__FILE__).'/calendarSystems/thai.class.inc.php');
			return new cmfcCalendarV1Thai($options);
		}
	}
